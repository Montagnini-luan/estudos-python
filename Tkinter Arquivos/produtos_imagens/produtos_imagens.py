...
def carregarDados():
    df = pd.read_excel('C:\\Users\\luanm\\OneDrive\\Desktop\\Sites\\Estudos\\estudos python\\Tkinter Arquivos\\produtos_imagens\\Vendedor.xlsx')
...
def exibir_tooltip(evento):
    ...
    if id_linha:
        ...
        caminho_imagem = os.path.join(f'C:\\Users\\luanm\\OneDrive\\Desktop\\Sites\\Estudos\\estudos python\\Tkinter Arquivos\\produtos_imagens\\imagem', f'{produto}.jpg')
